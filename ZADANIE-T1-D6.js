...
*/
odpowiedź("A");
uzasadnienie(`typy danych czyli np. string/array/object`);
...
*/
odpowiedź("const");
uzasadnienie(`poprzez uzycie const tworzymy stałą zmienną`);
...
odpowiedź("undefined");
uzasadnienie(
  `f to funkcja a nie obiekt wiec nie mozemy zwrocic do konsoli f.o`
);
...
*/
odpowiedź("B");
uzasadnienie(`na logike pętla = powtrzające się czynności`);
...
odpowiedź("5");
uzasadnienie(
  `i to 5, pętla działa do momentu nieprzekroczenia wartości 100 przez i, a i co kazde wykonanie petli to i * 2, wiec i bedzie wygladac tak: 5, 10, 20, 40, 80, [...] wiec pętla zwroci do konsoli xNzq 5 razy`
);
...
odpowiedź("1010");
uzasadnienie(
  `jezeli dodamy number do stringa to po prostu przekonwertuje nam number na stringa i doda do stringa`
);
...
uzasadnienie(`9 bo array zaczyna indeksowanie od 0`);
...
*/
odpowiedź("Infinity");
uzasadnienie(`powstanie nieskończona pętla`);
